<?php 
  ...
  if (isset($_SESSION['username'])) {
  	...
  	include 'chatHelper/getChat.php';
...
<script>
	...
	$(document).ready(function(){
      ...
      // auto refresh, yhis just refreshes every .5 seconds methinks
      let fechData = function(){
      	$.post("ajax/chatUp.php", 
      		   {
